      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-8">
          ...
          <button
            ...
            disabled={loading || googleLoading}
            className="w-full bg-white dark:bg-zinc-700 text-gray-700 dark:text-gray-300 font-medium py-3 px-4 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-zinc-600 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 mb-8"
          >
